...
// 		await uploadFileCloudinary(file, "unsigned_video", "ProgressBarVideo", "TextProgressBarVideo")
//		.then( async (audioFileXhr) => {
...
// 			await uploadFileCloudinary(picture, "unsigned_image", "ProgressBarPicture", "TextProgessBarPicture")
//			.then((pictureFileXhr) => {
