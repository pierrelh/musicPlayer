...
<section id="AudioPlayer" class="left">
	...
	<section id="Controls">
		...
		<img id="Random" class="reader-buttons" src="<?php echo $link ?>/img/no-random.png" alt="random">
		<img id="Mute" class="reader-buttons mute" src="<?php echo $link ?>/img/audio-on.png" alt="">
