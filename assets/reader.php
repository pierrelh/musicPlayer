...
<section id="audio-player" class="left">
  <ul>
    ...
    <li>
      <div id="controls">
        <i id="loop" onclick="setLoop('one')" class="fa-loop"></i>
        <img id="Previous" class='previous player-button' src="../img/back.png" alt="">
        <i id="play" class="fa-pause"></i>
        ...
        <i id="random" onclick="setRandom(true)" class="fa-no-random"></i>
        <i id="mute" class="fa-volume-up"></i>
