...
<link rel="stylesheet" href="<?php echo $link ?>/styles/common/loginStyle.css?cachev=<?php echo $cacheVersion ?>">
<link rel="stylesheet" href="<?php echo $link ?>/styles/screen/loginStyle.css?cachev=<?php echo $cacheVersion ?>">
<link rel="stylesheet" href="<?php echo $link ?>/styles/handheld/loginStyle.css?cachev=<?php echo $cacheVersion ?>">
